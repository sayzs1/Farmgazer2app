              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 ml-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`inline-block px-2 py-0.5 rounded-[5px] text-xs font-normal mr-4 capitalize ${
                      colorSchemes[detection.category_tag.toLowerCase() as keyof typeof colorSchemes] || 'bg-gray-100 text-gray-800'
                    }`}>
